<!-- dox-managed:v2 -->
# World_Cup_Database Repository Contract

## Core Contract

- This file is the root work contract for `dominick253/World_Cup_Database`.
...
| `insert_data.sh` | Root project file or artifact. |
| `queries.sh` | Root project file or artifact. |
| `worldcup.sql` | Root project file or artifact. |
...
No automated project command was discovered. Do not claim build or test success until tooling exists or a documented manual check is complete.
